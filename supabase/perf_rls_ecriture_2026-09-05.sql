...
create policy "affiche delete (page:affichage)" on public.affiche_templates
  ...
  using ((((select public.get_page_level('affichage')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('affichage'))) >= 2) AND (created_by = auth.uid()))));
...
create policy "affiche update (page:affichage)" on public.affiche_templates
  ...
  using ((((select public.get_page_level('affichage')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('affichage'))) >= 2) AND (created_by = auth.uid()))))
  with check ((((select public.get_page_level('affichage')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('affichage'))) >= 2) AND (created_by = auth.uid()))));
...
create policy "baby_cot_assignments delete (page:literie)" on public.baby_cot_assignments
  for delete to authenticated
  using ((((select public.get_page_level('literie')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('literie'))) >= 2) AND (end_date >= (CURRENT_DATE - 2)))));
...
create policy "baby_cot_assignments write (page:literie)" on public.baby_cot_assignments
  for insert to authenticated
  with check ((((select public.get_page_level('literie')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('literie'))) >= 2) AND (start_date >= (CURRENT_DATE - 2)))));
...
create policy "baby_cot_assignments update (page:literie)" on public.baby_cot_assignments
  for update to authenticated
  using ((((select public.get_page_level('literie')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('literie'))) >= 2) AND (end_date >= (CURRENT_DATE - 2)))))
  with check ((((select public.get_page_level('literie')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('literie'))) >= 2) AND (end_date >= (CURRENT_DATE - 2)))));
...
create policy "caisse cautions delete (page:caisse)" on public.caisse_cautions
  for delete to authenticated
  using ((((select public.get_page_level('caisse')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('caisse'))) >= 2) AND (taken_date = CURRENT_DATE))));
...
create policy "caisse write (page:caisse)" on public.caisse_sheets
  for insert to authenticated
  with check ((((select public.get_page_level('caisse')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('caisse'))) >= 2) AND (report_date >= (CURRENT_DATE - 1)))));
...
create policy "caisse update (page:caisse + verrou)" on public.caisse_sheets
  for update to authenticated
  using ((((select public.get_page_level('caisse')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('caisse'))) >= 2) AND (report_date >= (CURRENT_DATE - 1)))))
  with check ((((select public.get_page_level('caisse')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('caisse'))) >= 2) AND (report_date >= (CURRENT_DATE - 1)))));
...
create policy "forecast_days write (page:repjour)" on public.forecast_days
  for insert to authenticated
  with check ((((select public.get_page_level('repjour')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('repjour'))) >= 2) AND repjour_manual_forecast_allowed(year, month))));
...
create policy "forecast_days update (page:repjour)" on public.forecast_days
  for update to authenticated
  using ((((select public.get_page_level('repjour')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('repjour'))) >= 2) AND repjour_manual_forecast_allowed(year, month))))
  with check ((((select public.get_page_level('repjour')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('repjour'))) >= 2) AND repjour_manual_forecast_allowed(year, month))));
...
create policy "literie_sheets write (page:literie)" on public.literie_sheets
  for insert to authenticated
  with check ((((select public.get_page_level('literie')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('literie'))) >= 2) AND (report_date >= (CURRENT_DATE - 2)))));
...
create policy "literie_sheets update (page:literie)" on public.literie_sheets
  for update to authenticated
  using ((((select public.get_page_level('literie')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('literie'))) >= 2) AND (report_date >= (CURRENT_DATE - 2)))))
  with check ((((select public.get_page_level('literie')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('literie'))) >= 2) AND (report_date >= (CURRENT_DATE - 2)))));
...
create policy "parking delete (page:parking)" on public.parking_reservations
  for delete to authenticated
  using ((((select public.get_page_level('parking')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('parking'))) >= 2) AND ((start_date + (nights)::integer) >= (CURRENT_DATE - 7)))));
...
create policy "parking write (page:parking)" on public.parking_reservations
  for insert to authenticated
  with check ((((select public.get_page_level('parking')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('parking'))) >= 2) AND (start_date >= (CURRENT_DATE - 7)))));
...
create policy "parking update (page:parking)" on public.parking_reservations
  for update to authenticated
  using ((((select public.get_page_level('parking')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('parking'))) >= 2) AND ((start_date + (nights)::integer) >= (CURRENT_DATE - 7)))))
  with check ((((select public.get_page_level('parking')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('parking'))) >= 2) AND ((start_date + (nights)::integer) >= (CURRENT_DATE - 7)))));
...
create policy "pdj addon write (page:pdj)" on public.pdj_addon_production
  for insert to authenticated
  with check ((((select public.get_page_level('pdj')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('pdj'))) >= 2) AND (service_date >= (CURRENT_DATE - 3)))));
...
create policy "pdj addon update (page:pdj)" on public.pdj_addon_production
  for update to authenticated
  using ((((select public.get_page_level('pdj')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('pdj'))) >= 2) AND (service_date >= (CURRENT_DATE - 3)))))
  with check ((((select public.get_page_level('pdj')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('pdj'))) >= 2) AND (service_date >= (CURRENT_DATE - 3)))));
...
create policy "profiles insert (bornee)" on public.profiles
  for insert to authenticated
  with check (((select public.is_admin()) OR ((id = auth.uid()) AND (role = 'utilisateur'::text))));
...
create policy "rapro_rooms delete (page:rapro)" on public.rapro_rooms
  for delete to authenticated
  using ((((select public.get_page_level('rapro')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('rapro'))) >= 2) AND (report_date >= (CURRENT_DATE - 2)))));
...
create policy "rapro_rooms write (page:rapro)" on public.rapro_rooms
  for insert to authenticated
  with check ((((select public.get_page_level('rapro')) = 'gestion') OR (((select public.page_level_rank(public.get_page_level('rapro'))) >= 2) AND (report_date >= (CURRENT_DATE - 2)))));
