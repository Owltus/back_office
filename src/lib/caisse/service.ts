...
export function toSheet(r: DbCaisseSheet): CaisseSheet {
  ...
  return {
    ...
    snt: {
      cash: num(r.snt_cash), cb: num(r.snt_cb),
      cvac: num(r.snt_cvac), cbweb: num(r.snt_cbweb),
    },
    ls: {
      cash: num(r.ls_cash), cb: num(r.ls_cb), cvac: num(r.ls_cvac),
    },
    caisse: {
      cash: num(r.caisse_cash), cb: num(r.caisse_cb),
      cvac: num(r.caisse_cvac), adyen: num(r.caisse_adyen),
    },
    counts,
...
export function toDbUpsert(s: CaisseSheetInput): Partial<DbCaisseSheet> {
  ...
  return {
    ...
    snt_cash: s.snt.cash, snt_cb: s.snt.cb,
    snt_cvac: s.snt.cvac, snt_cbweb: s.snt.cbweb,
    ls_cash: s.ls.cash, ls_cb: s.ls.cb, ls_cvac: s.ls.cvac,
    caisse_cash: s.caisse.cash, caisse_cb: s.caisse.cb,
    caisse_cvac: s.caisse.cvac, caisse_adyen: s.caisse.adyen,
    ...counts,
