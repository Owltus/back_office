...
/*
 * Card « Prévisualisation graphique » (haut du rail droit). Lien vers la page pleine
 * `/facturation/galaxie` (galaxie ECharts). Désactivée tant qu'aucune donnée apprise
 * n'est disponible. La revue/curation vit ailleurs (bouton engrenage de l'émetteur).
 */
